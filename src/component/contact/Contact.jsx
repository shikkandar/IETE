...
export const Contact = () => {
  return (
   <>
    ...
    <div className='form'>
    <img className='contact-img1' src="/img/svg/undraw_social_thinking_re_y8cc.svg" alt="img" />
        <form action="">
            ...
            <textarea name="" id="" cols="30" rows="5" placeholder='Message...' required minLength={40}></textarea>
            
            <button type='submit'>Send-Mail</button>
        </form>
        <img className='contact-img2' src="/img/svg/undraw_social_thinking_re_y8cc.svg" alt="img" />
    </div>
    </div>
