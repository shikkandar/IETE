     ...
     <div className="event2-con1">
        ...
        Recently, the use of AI/ML technology has been exponentially increasing in our daily lives. AI/ML applications represent an important evolution in computer science and data processing that is quickly transforming a vast array of domains. IETE CHENCON 2022 provides vibrant opportunities for the delegates to exchange new ideas, applications, practical challenges encountered and to leverage AI and ML technologies. The technical program of the conference will consist of invited key note talks and paper presentations. IETE CHENCON 2022 accepts technical paper presentation from research scholars, faculty, students and industry professionals in emerging areas of AI and ML applications but not limited to:
         ...
         <div className="event2-con1-orange">
          ...
          <div className="event2-con1-gray-1">
              Prospective authors are invited to submit full papers describing original, previously unpublished, complete work in four
              pages in A4 IEEE double column conference template, including figure, results and references. Submitted papers will be reviewed
              by two to three technical committee or reviewers. Accepted and registered papers of IETE CHENCON 2022 will be published in 
              the conference proceedings. Extended versions of the accepted and presented papers will be recommended for publication in
              IETE Journals, SCOPUS, SCI and other indexed journals. Authors must submit the papers through their Easy chair account 
              using the following link: <a href='https://easychair.org/conferences/?conf=ietechencon2022' className='event2-con1-blue-1'>https://easychair.org/conferences/?conf=ietechencon2022</a> or submit
              the papers to the Email ID: <span className='event2-con1-blue-1'> chencon2022@gmail.com</span>      
         ...
         <div className="event2-con1-orange-blue" >
            ...
            <table>
                <tr>
                  <td>
                      <div>
                          <br/>
                          <h1>Patron</h1>
                          Prof Wg Cdr P. Prabhakar<br/><br/>

                          <h1>Organizing Chair</h1>
                          Dr. N. Venkateswaran<br/><br/>
                ...
                <tr>
                  ...
                  <div>
                          ...
                          Email: <span className='event2-con1-blue-1'> chencon2022@gmail.com</span> <br/>
                          Website: <a href='http://ietechennai.in' className='event2-con1-blue-1' >http://ietechennai.in</a>
                      </div>
                  </td>
                </tr>
            </table>
